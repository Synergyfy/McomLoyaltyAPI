...
export class AddTagsToNetwork1767012627795 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "networks" ADD "locationTag" "public"."networks_locationtag_enum"`);
        await queryRunner.query(`CREATE TYPE "public"."networks_relationshiptag_enum" AS ENUM('partner', 'customer', 'supplier', 'affiliate')`);
        await queryRunner.query(`ALTER TABLE "networks" ADD "relationshipTag" "public"."networks_relationshiptag_enum"`);
    }
