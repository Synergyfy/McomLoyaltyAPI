...
export class UpdateTierEntity1765809575727 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tier" ADD "type" "public"."tier_type_enum" NOT NULL DEFAULT 'standard'`);
        ...
        await queryRunner.query(`ALTER TABLE "tier" ADD "color_code" character varying`);
        await queryRunner.query(`ALTER TABLE "tier" ADD "fixed_price" numeric(10,2) DEFAULT '0'`);
    }
