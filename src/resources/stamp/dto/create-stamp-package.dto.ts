...
import { IsString, IsNotEmpty, IsInt, IsNumber, IsBoolean, IsArray, IsUUID } from 'class-validator';
...
export class CreateStampPackageDto {
    ...
    @ApiProperty({ description: 'Tiers that can purchase this package', type: [String] })
    @IsArray()
