...
import { Column, Entity, Index, ManyToOne, OneToMany, ManyToMany } from 'typeorm';
...
export class Deal extends AbstractBaseEntity {
  ...
  @ApiProperty({ description: 'Short description of the deal', required: false })
  @Column({ nullable: true })
  ...
  @Column({ type: 'enum', enum: RedemptionMethod, default: RedemptionMethod.QR_SCAN })
  ...
  @Column({ type: 'enum', enum: DealVisibility, default: DealVisibility.PUBLIC })
  visibility: DealVisibility;

  @ApiProperty({ description: 'Whether this deal can be redeemed with points', default: false })
  @Column({ default: false })
  isReward: boolean;

  @ApiProperty({ description: 'Points required to redeem this deal', required: false })
  @Column({ nullable: true })
  pointsCost: number;

  @ApiProperty({ description: 'Points earned when purchasing this deal', default: 0 })
  @Column({ default: 0 })
  pointsEarned: number;
  ...
  @ManyToMany(() => BusinessCampaign, (businessCampaign) => businessCampaign.deals)
