...
describe('BusinessController Endpoints', () => {
    ...
    describe('getSubscription', () => {
        it('should return subscription level', async () => {
            ...
            expect(await controller.getSubscription({ user: { id: '1' } })).toBe(result);
            expect(mockBusinessService.getSubscriptionLevel).toHaveBeenCalledWith('1');
        });
    });
    ...
    describe('getBillingHistory', () => {
        it('should return billing history', async () => {
            ...
            expect(await controller.getBillingHistory({ user: { id: '1' } })).toBe(result);
    ...
    describe('getOnboardingStatus', () => {
        it('should return onboarding status', async () => {
            ...
            expect(await controller.getOnboardingStatus({ user: { id: '1' } })).toBe(result);
