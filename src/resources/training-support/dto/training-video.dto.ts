...
import { IsString, IsEnum, IsOptional, IsUrl, IsArray, IsUUID } from "class-validator";
...
export class CreateTrainingVideoDto {
    ...
    @ApiProperty({ example: "This video will guide you through the initial setup process." })
    @IsString()
    description: string;
