...
export class DataPerTierDto {
    ...
    @ApiProperty({
        description: "The number of businesses in this tier that claimed the campaign.",
        example: 10,
    })
    claimsCount: number;

    @ApiProperty({
        description: "The total number of participants across all businesses in this tier.",
        example: 150,
    })
