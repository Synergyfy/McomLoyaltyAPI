...
export class SystemSettingService {
    ...
    async set(createSystemSettingDto: CreateSystemSettingDto): Promise<SystemSetting> {
        let setting = await this.systemSettingRepository.findOne({ where: { key: createSystemSettingDto.key } });
