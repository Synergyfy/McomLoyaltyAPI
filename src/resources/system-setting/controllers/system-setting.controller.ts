...
export class SystemSettingController {
    ...
    @ApiResponse({ status: 201, description: 'The setting has been successfully set.', type: SystemSetting })
    ...
    @ApiResponse({ status: 200, description: 'List of all settings.', type: [SystemSetting] })
    async findAll() {
