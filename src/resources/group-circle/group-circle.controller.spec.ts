...
describe('GroupCircleController', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        { provide: GroupCircleService, useValue: mockService },
      ],
    }).compile();
  ...
  describe('getMessages', () => {
    it('should call service.getMessages with correct params', async () => {
      ...
      await controller.getMessages(circleId, business, 2, 10, GroupMessageType.GROUP, 'mem1');
      expect(service.getMessages).toHaveBeenCalledWith(circleId, 'bus1', 2, 10, GroupMessageType.GROUP, 'mem1');
    });
    ...
    it('should use default params', async () => {
        ...
        expect(service.getMessages).toHaveBeenCalledWith(circleId, 'bus1', 1, 20, undefined, undefined);
      });
  });
});
