...
export class GroupCircle extends AbstractBaseEntity {
    ...
    @ApiProperty({ enum: GroupCircleVisibility, description: 'Visibility settings' })
    ...
    @Column({ type: 'enum', enum: GroupCircleStatus, default: GroupCircleStatus.ACTIVE })
    ...
    @ApiProperty({ description: 'Contribution amount for Smart Money', required: false })
    ...
    @ApiProperty({ description: 'Current round for Smart Money', required: false })
