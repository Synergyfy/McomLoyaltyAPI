...
export class PointPackageService {
    ...
    async create(createPointPackageDto: CreatePointPackageDto): Promise<PointPackage> {
    ...
    async findAll(page: number, limit: number): Promise<PaginationResult<PointPackage>> {
    ...
    async update(id: string, updatePointPackageDto: UpdatePointPackageDto): Promise<PointPackage> {
