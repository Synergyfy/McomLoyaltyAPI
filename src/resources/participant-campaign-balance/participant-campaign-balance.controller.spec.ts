...
describe('ParticipantCampaignBalanceController', () => {
  ...
  beforeEach(async () => {
    ...
    controller = module.get<ParticipantCampaignBalanceController>(ParticipantCampaignBalanceController);
    ...
    transactionCodeService = module.get<TransactionCodeService>(TransactionCodeService);
    participantCampaignBalanceService = module.get<ParticipantCampaignBalanceService>(ParticipantCampaignBalanceService);
  });
