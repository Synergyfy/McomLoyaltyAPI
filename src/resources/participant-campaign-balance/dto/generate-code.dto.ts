...
import { IsEnum, IsInt, IsNotEmpty, IsOptional, IsUUID, Min, IsDateString } from 'class-validator';
...
export class GenerateCodeDto {
  ...
  @ApiProperty({ description: 'The amount of points to award (required for EARN, optional for REDEEM if linked to reward)', required: false })
  @IsInt()
  @Min(1)
  @IsOptional()
  points?: number;
