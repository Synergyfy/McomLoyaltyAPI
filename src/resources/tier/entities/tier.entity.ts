...
export class Tier extends AbstractBaseEntity {
  ...
  @ApiProperty({ description: 'The type of tier', enum: TierType, example: TierType.STANDARD })
  @Column({
    type: 'enum',
    enum: TierType,
  ...
  @ApiProperty({ description: 'Start date for seasonal tier', required: false, example: '2025-06-01T00:00:00Z' })
  @Column({ type: 'timestamp', nullable: true })
  start_date: Date;

  @ApiProperty({ description: 'End date for seasonal tier', required: false, example: '2025-08-31T00:00:00Z' })
  @Column({ type: 'timestamp', nullable: true })
  end_date: Date;

  @ApiProperty({ description: 'Color code', required: false, example: '#FF5733' })
  @Column({ nullable: true })
  color_code: string;

  @ApiProperty({ description: 'Fixed price for seasonal tier', required: false, example: 99.99 })
  ...
  @ApiProperty({ description: 'List of features', example: ['Feature 1', 'Feature 2'] })
  @Column('simple-array')
  features: string[];

  @ApiProperty({ description: 'Status of the tier', enum: TierStatus, example: TierStatus.PUBLISHED })
  @Column({
    type: 'enum',
    enum: TierStatus,
  ...
  @ApiProperty({ description: 'Number of QR Code/Plaques included', default: 0 })
